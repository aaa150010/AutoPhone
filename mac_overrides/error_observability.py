...
NODE_LABELS = {
    ...
    "free_pool_preflight": "Free 邮箱池预检",
...
_ACTION_HINTS = {
    ...
    "phone_plan_free_skipped": "如确需为 free 账号接码，请在 SMS 接码设置中开启“允许 free 账号接码”。",
    "phone_plan_unknown_skipped": "检查 ChatGPT 登录会话和套餐查询网络后重试；确需忽略套餐时可开启“允许 free 账号接码”。",
...
_RULES = (
    ...
    (("phone_plan_free_skipped",), "phone_acquiring", "phone_plan_free_skipped", "当前账号套餐为 free，已按默认设置停止且未调用接码平台", False),
    (("phone_plan_unknown_skipped",), "phone_acquiring", "phone_plan_unknown_skipped", "无法确认当前账号套餐，已按省成本设置停止且未调用接码平台", True),
