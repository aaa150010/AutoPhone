...
Payload constants, errors, sanitisation helpers and the HTTP client live in
``pixel_payload`` / ``pixel_client``; this module keeps the durable upload
queue and re-exports the moved names for compatibility.
"""
...
try:
    from .pixel_payload import (
        ...
        _CREDENTIAL_FIELDS,
        _DUPLICATE_ACCOUNT_RE,
        _EMAIL_RE,
        _EXISTING_ACCOUNT_ID_RE,
        _GENERATED_EMAIL_LOCAL_RE,
        _IDENTITY_FIELDS,
        _IDENTITY_MATCH_FIELDS,
        _RETRYABLE_STATES,
        _SANITIZE_INPUT_LIMIT,
        _SECRET_KEYS,
        ...
        _clean,
        _concurrency_by_id,
        _duplicate_import_details,
        _first_value,
        _payload_email_domain,
        _pixel_failure,
        _public_pixel_failure,
        _public_proxy_value,
        _result_generated_names,
        _safe_account_id_values,
        _safe_identifier,
        _safe_int,
        _source_public_metadata,
        _stage_for_state,
        _target_stage,
        _valid_generated_name,
        _value_sources,
...
try:
    from .pixel_client import PixelProxyClient, PixelTransport, UrllibPixelTransport
except ImportError:  # macOS launcher imports overrides as top-level modules.
    from pixel_client import (  # type: ignore[no-redef]
        PixelProxyClient,
        PixelTransport,
