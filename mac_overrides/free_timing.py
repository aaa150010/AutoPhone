...
FREE_TIMING_SUBSTEPS: dict[str, str] = {
    ...
    # Browser lifecycle and navigation checkpoints.
    "camoufox_pool_admission": "Camoufox 池 admission",
    "camoufox_context_create": "Camoufox context 创建",
    "camoufox_page_create": "Camoufox page 创建",
    "camoufox_initial_navigation": "Camoufox 初始导航",
    "camoufox_entry_form_wait": "Camoufox 登录表单探测",
    "camoufox_entry_transition_wait": "Camoufox 邮箱提交后跳转",
    # Same-origin auth/session checkpoints.
    "auth_csrf_fetch": "认证 CSRF 请求",
    "auth_signin_fetch": "认证 signin 请求",
    "oauth_callback_navigation": "OAuth callback 导航",
    "session_fetch": "Session 请求",
    "otp_validate_fetch": "邮箱验证码校验请求",
    "plan_accounts_fetch": "套餐 accounts 请求",
    "plan_eligibility_fetch": "套餐 eligibility 请求",
    "plan_fallback_fetch": "套餐兜底请求",
    "password_eligibility_fetch": "密码资格请求",
    "password_add_fetch": "密码提交请求",
    "mfa_info_fetch": "2FA 状态请求",
    "mfa_enroll_fetch": "2FA enrollment 请求",
    "mfa_activate_fetch": "2FA activation 请求",
