...
import { Cellphone, ChatDotRound, Clock, Connection, Key, Message, UploadFilled } from '@element-plus/icons-vue'
...
const stages: Array<{
  ...
  { key: 'free', title: 'Free 注册', icon: Key, tone: 'primary' },
...
<style scoped>
.stage-metrics { display: grid; grid-template-columns: repeat(7, minmax(0, 1fr)); gap: 8px; }
