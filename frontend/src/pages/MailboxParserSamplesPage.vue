...
<template>
  <div class="sample-page">
    ...
    <WorkspacePanel title="未识别响应" :icon="Warning" fill body-padding="none">
      ...
      <el-table :data="samples" row-key="sample_id" height="100%" stripe border v-loading="loading" @selection-change="selectRows" size="small">
